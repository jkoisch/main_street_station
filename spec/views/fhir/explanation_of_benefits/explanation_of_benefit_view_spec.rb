...
describe 'FHIR ExplanationOfBenefit View', type: :view do
  ...
  context 'standard' do
    ...
    context 'XML' do
      ...
      it {should match_fhir_xml(support_file('explanation_of_benefits/explanation_of_benefit-standard.xml')) }
    end
  end
  ...
  context 'complete' do
    ...
    context 'XML' do
      ...
      it {should match_fhir_xml(support_file('explanation_of_benefits/explanation_of_benefit-complete.xml')) }
    end
  end
