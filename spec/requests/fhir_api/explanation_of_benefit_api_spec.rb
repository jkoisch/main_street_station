...
describe 'ExplanationOfBenefit Request FHIR API', type: :request do
  describe 'GET /fhir/ExplanationOfBenefit' do
    ...
    context 'XML' do
      ...
      context 'success' do
        ...
        it 'should return a FHIR Bundle' do
          get '/fhir/ExplanationOfBenefit', params: {}, headers: headers
  ...
  describe 'GET /fhir/ExplanationOfBenefit/1' do
    context 'JSON' do
      it { should return_FHIR_JSON_object('ExplanationOfBenefit') }

      it { should return_HTTP_success_for('ExplanationOfBenefit/1') }
    end
    ...
    context 'XML' do
      ...
      context 'success' do
        it 'should return a FHIR resource' do
          get '/fhir/ExplanationOfBenefit/1', params: {}, headers: headers
