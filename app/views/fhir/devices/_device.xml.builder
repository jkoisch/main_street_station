xml.tag!('Device', xmlns: 'http://hl7.org/fhir') {
  ...
  xml.owner { |xml| xml << render('fhir/base/reference', {reference: resource.owner})} unless resource.owner.nil?
  xml.location { |xml| xml << render('fhir/base/reference', {reference: resource.location})} unless resource.location.nil?
