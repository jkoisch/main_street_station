...
xml.request { |xml| xml << render('fhir/base/reference', {reference: event.request})} unless event.request.nil?
xml.response { |xml| xml << render('fhir/base/reference', {reference: event.response})} unless event.response.nil?
