...
# xml.author { |xml| xml << render('fhir/base/reference', {reference: resource.author})} unless resource.author.nil?
# xml.source { |xml| xml << render('fhir/base/reference', {reference: resource.source})} unless resource.source.nil?
