xml.authorReference{ |xml| xml << render('fhir/base/resource_reference', {resource_reference: annotation.author_resource_reference})} unless annotation.author_resource_reference.nil?
